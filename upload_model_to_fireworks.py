...
resp = requests.post(
    ...
    json={
        ...
        "model": {
            "kind": "HF_BASE_MODEL",
            "huggingFaceUrl": "https://huggingface.co/OpenGVLab/InternVL3-78B",
            "baseModelDetails": {
...
log_response("Step 1: Create model", resp)

if resp.status_code == 409:
    print(f"Model {MODEL_ID} already exists, continuing...")
...
log_response("Step 2: Get upload endpoint", resp)
resp.raise_for_status()
...
while True:
    ...
    if resp.status_code == 200:
        ...
        break
    log_response("Step 4: Validate upload", resp)
